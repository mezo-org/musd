 ...
 * @dev Adapted from TroveManager.sol to support ERC20 tokens as collateral instead of native tokens.
 *      Key differences:
 *      - Collateral is tracked via ERC20 token transfers through pool contracts
 *      - No payable functions - all collateral transfers use SafeERC20
 *      - Uses ERC20-specific pool interfaces (IActivePoolERC20, IDefaultPoolERC20, etc.)
 */
    ...
    OwnableUpgradeable
{
    ...
    function redeemCollateral(
        ...
        require(
            ...
            "TroveManagerERC20: Unable to redeem any amount"
        );
    ...
    function batchLiquidateTroves(
        ...
        require(
            ...
            "TroveManagerERC20: Calldata address array must not be empty"
        );
        ...
        IDefaultPoolERC20 defaultPoolCached = defaultPool;
        ...
        require(
            ...
            "TroveManagerERC20: nothing to liquidate"
        );
    ...
    function _requireTCRoverMCR(uint256 _price) internal view {
        require(
            _getTCR(_price) >= MCR,
            "TroveManagerERC20: Cannot redeem when TCR < MCR"
        );
    }
    ...
    function _requireMUSDBalanceCoversRedemption(
        ...
        require(
            ...
            "TroveManagerERC20: Requested redemption amount must be <= user's mUSD token balance"
        );
    }
    ...
    function _requireMoreThanOneTroveInSystem(
        ...
        require(
            ...
            "TroveManagerERC20: Only one trove in the system"
        );
    }
    ...
    function _requireCallerIsBorrowerOperations() internal view {
        require(
            ...
            "TroveManagerERC20: Caller is not the BorrowerOperations contract"
        );
    }
    ...
    function _requireTroveIsActive(address _borrower) internal view {
        require(
            Troves[_borrower].status == Status.active,
            "TroveManagerERC20: Trove does not exist or is closed"
        );
    }
    ...
    function _requireAmountGreaterThanZero(uint256 _amount) internal pure {
        require(
            _amount > 0,
            "TroveManagerERC20: Amount must be greater than zero"
        );
    }
