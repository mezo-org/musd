...
/**
 * @title LiquityBaseERC20
 * @notice Base contract for ERC20 collateral versions of TroveManager, BorrowerOperations, and StabilityPool
 * @dev Contains global system constants and common functions adapted for ERC20 collateral
 */
abstract contract LiquityBaseERC20 is BaseMath, ILiquityBase {
